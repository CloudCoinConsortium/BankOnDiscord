async def Help():
    ...
    return mainContent  + balanceContent + lockContent + depositContent + transferContent + payContent + myWalletContent
...
async def payHelp():
    return "\n\n** ⮂ PAY ** \n Moves coins from your account to Owner's Discord account.\nExample:\n/pay <amount> \nsuch as:\n/pay 10.33 "
